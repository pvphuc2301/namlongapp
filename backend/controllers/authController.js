...
const createSendToken = (user, statusCode, res) => {
    ...
    if (process.env.NODE_ENV === 'production')
        cookieOptions.secure = true; // only accessible over https
...
const _createSendToken = (user, statusCode, res) => {
    ...
    if (process.env.NODE_ENV === 'production') cookieOptions.secure = true; // only accessible over https
    ...
    res.cookie('jwt', refreshToken, cookieOptions); // add token to cookie

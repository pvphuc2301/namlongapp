...
const RequiredAuth = ({ allowedRoles = [] }) => {
    ...
    return allowedRoles.includes(userInfo?.role) ? <Outlet /> :
        <Result status="403" title="403" subTitle="Sorry, you are not authorized to access this page." extra={<Link to="/my-cart" state={{ from: location }} replace>Back Home</Link>} />
